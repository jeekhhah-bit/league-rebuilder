...
export function StandingsTable({ teams: propTeams, readOnly }: StandingsTableProps) {
  const { teams: storeTeams } = useLeagueStore();
            ...
            {sortedTeams.map((team, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3 md:py-4 px-2 text-center text-emerald-400 text-sm">{team.won}</td>
                  ...
                  <td className={cn('py-3 md:py-4 px-2 text-center font-medium text-sm', goalDiff > 0 ? 'text-emerald-400' : goalDiff < 0 ? 'text-coral' : '')}>
