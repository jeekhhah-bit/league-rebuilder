...
export function LeagueHeader() {
  const { teams, settings } = useLeagueStore();
      ...
      <div className="relative z-10 animate-fade-in">
        ...
        <div className="mt-6 flex justify-center gap-12">
          <div className="text-center flex flex-col items-center gap-2">
            ...
            <p className="text-primary font-medium text-sm">Coach {team1?.coach}</p>
          </div>
          ...
          <div className="text-center flex flex-col items-center gap-2">
            ...
            <p className="text-secondary font-medium text-sm">Coach {team2?.coach}</p>
          </div>
        </div>
      </div>
    </header>
